...
#import <Preferences/PSSearchResultsControllerDelegate.h>
...
@property (nonatomic,weak,readonly) PSListController * listController;                  //@synthesize listController=_listController - In the implementation block
