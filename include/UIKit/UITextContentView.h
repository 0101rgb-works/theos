...
#import <UIKit/WebPolicyDelegate.h>
...
@property (assign,nonatomic) long keyboardAppearance;
...
@property (assign,nonatomic) long selectionAffinity;
-(id)_automationValue;
...
-(long)selectionAffinity;
-(void)setSelectionAffinity:(long)arg1 ;
